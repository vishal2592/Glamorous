...
import { Legg } from '../store/Legg'
import Heading from '../component/Heading'
import { FaRegHeart } from "react-icons/fa";
import { FiEye } from "react-icons/fi";
import { MdCurrencyRupee } from "react-icons/md";
import { useNavigate } from 'react-router-dom';
import image1 from '../assets/images/legg/banner.png'
import image2 from '../assets/images/legg/banner1.png'
    ...
    return (
        <div className='bg-[#E7E1B1]'>
            <div>
                <Heading
                    title={"LEGGINGS"}
                    currentPage={"Leggings"}
                    currentPath={"/leggingpage"}
                    description="Explore our premium leggings collection, designed with soft, stretchable fabrics for all-day comfort and flexibility. Featuring flattering fits and versatile styles, these leggings are perfect for workouts, casual outings, lounging, or everyday wear, helping you stay comfortable, confident, and effortlessly stylish."
                />
            </div>
            {/* Main Layout Section */}
