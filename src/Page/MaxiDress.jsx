...
import image1 from '../assets/images/maxi/bannermaxi.png'
import image2 from '../assets/images/maxi/banner2.png'
    ...
    return (
        <div className='bg-[#E7E1B1]'>
            <div>
                <Heading
                    title={"Maxi Dress"}
                    currentPage={"MAXI DRESS"}
                    currentPath={"/maxidress"}
                    description={"Unleash your fun fashion sense with our Maxi Dress Collection. Featuring bright prints and sleek shapes, these dresses are perfect for day and night. A must-have addition to your wardrobe. "}
                />
            </div>
            {/* Main Layout Section */}
