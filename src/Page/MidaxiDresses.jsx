...
import { midaxi } from '../store/Midaxi';
import image1 from '../assets/images/midi/banner.png'
...
const MidaxiDresses = () => {
    ...
    return (
        <div className='bg-[#E7E1B1]'>
            <div>
                <Heading
                    currentPage="MIDAXI DRESS"
                    currentPath="/midaxidress"
                    title="MIDAXI DRESSES"
                    description="Make an impact with our range of midi and midaxi dresses. From bold prints to sequin styles. We have a dress to suit everyone. Whether you opt to keep it casual with a wrap design or elevate your look with a tie-back occasion dress, you can’t go wrong with one of our longer styles. Pair with chunky ankle boots, platform heels or trainers depending on your mood. Our midi and midaxi dresses are fit for any occasion."
                />
            </div>
            {/* Main Layout Section */}
