...
import { Flare } from '../store/Flare'
import { FaRegHeart } from "react-icons/fa";
import { FiEye } from "react-icons/fi";
import { MdCurrencyRupee } from "react-icons/md";
import { useNavigate } from 'react-router-dom';
import image1 from '../assets/images/flare/flaredbanner.png'
...
const FlaredTrouser = () => {
    ...
    return (
        <div className='bg-[#E7E1B1]'>
            <div>
                <Heading
                    title="Flared Trouser"
                    currentPage="Flared Trouser"
                    currentPath="/flaredtrouser"
                    description="Get ready to make a statement with our Flared Trousers! Our collection features a mix of unique prints and fabrics, perfect for adding some serious style to your wardrobe. Say goodbye to boring bottoms and hello to fun and unique style!"
                />
            </div>
            {/* Main Layout Section */}
